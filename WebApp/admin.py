...
class AssignHomeworkInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['question_code', 'subject_code', 'lecture_code', 'chapter_code', 'member_code', 'use_flag',
...
class AssignQuestionInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['question_code', 'subject_code', 'lecture_code', 'chapter_code', 'question_type', 'use_flag',
...
class BoardContentInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['board_code', 'admin_id', 'title', 'contents', 'writer', 'view_cnt', 'ref_code', 'ref_step',
...
class CenterInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['center_name', 'center_location', 'center_tel', 'use_flag', 'reg_date', 'reg_time', 'reg_agent',
...
class ChapterContentMediaAdmin(admin.ModelAdmin):
    ...
    list_display = ['chapter_contents_code', 'media_type', 'media_desc', 'media_filename', 'use_flag', 'reg_date',
...
class ChapterContentsInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['chapter_code', 'chapter_contents', 'chapter_audio', 'use_flag', 'reg_date', 'reg_time',
                    'reg_agent', 'udt_date', 'udt_time', 'udt_agent', 'contents_index', 'chapter_type', 'thum_file',
                    'vod_file', 'today', 'front1_img', 'front1_text', 'back1_img', 'back1_text', 'pdf_file',
                    'front2_img', 'front3_img', 'front4_img', 'front2_text', 'front3_text', 'front4_text', 'back2_img',
                    'back3_img', 'back4_img', 'back2_text', 'back3_text', 'back4_text', 'c1_audio', 'c2_audio',
                    'c3_audio', 'c4_audio', 'vod_size', 'offline_file', 'teacher_guide', 'today_text', 'contents_text',
                    'pbl_allow', 'pbl_lec_allow']
...
class ChapterImgInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['chapter_code', 'filename', 'use_flag', 'reg_date', 'reg_time', 'reg_agent', 'udt_date', 'udt_time',
                    'udt_agent']
...
class ChapterInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['lecture_code', 'chapter_no', 'chapter_name', 'topic', 'summary', 'page_num', 'vod_size', 'intro',
                    'target', 'top_img', 'bottom_img1', 'bottom_img2', 'bottom_img3', 'thum_file', 'vod_file',
                    'use_flag', 'reg_date', 'reg_time', 'reg_agent', 'udt_date', 'udt_time', 'udt_agent', 'today',
                    'chapter_type', 'prologue_type', 'tabset', 'chapter_image', 'chapter_use', 'offline_file',
                    'pre_test_type', 'post_test_type', 'level1_avg', 'level2_avg', 'level3_avg', 'level1_hard_avg',
                    'level1_medium_avg', 'level1_easy_avg', 'level2_hard_avg', 'level2_medium_avg', 'level2_easy_avg',
                    'level3_hard_avg', 'level3_medium_avg', 'level3_easy_avg', 'homework_count', 'epilogue_type',
                    'epilogue_img', 'pbl_flag', 'chapter_use_time']
...
class ChapterMissonCheckAdmin(admin.ModelAdmin):
    ...
    list_display = ['check_code', 'check_item_code', 'student_code', 'check_agent_code', 'is_check_yn', 'use_flag',
...
class ChapterMissonCheckCardAdmin(admin.ModelAdmin):
    ...
    list_display = ['check_card_code', 'chapter_code', 'use_flag', 'reg_date', 'reg_time', 'reg_agent', 'udt_date',
                    'udt_time', 'udt_agent']
...
class ChapterMissonCheckItemAdmin(admin.ModelAdmin):
    ...
    list_display = ['check_item_code', 'check_card_code', 'item_text', 'contents_text', 'use_flag', 'reg_date',
...
class ChapterWriteAdmin(admin.ModelAdmin):
    ...
    list_display = ['inning_code', 'chapter_contents_code', 'student_code', 'write_content', 'use_flag', 'reg_date',
...
class GroupMappingAdmin(admin.ModelAdmin):
    ...
    list_display = ['center_code', 'group_code', 'member_code', 'use_flag', 'reg_date', 'reg_time', 'reg_agent',
                    'udt_date', 'udt_time', 'udt_agent']
...
class HomeworkInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['question_code', 'subject_code', 'lecture_code', 'chapter_code', 'level_score', 'use_flag',
...
class InningGroupAdmin(admin.ModelAdmin):
    ...
    list_display = ['center_code', 'inning_code', 'lecture_code', 'teacher_code', 'use_flag', 'reg_date', 'reg_time',
...
class InningInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['inning_name', 'lecture_code', 'start_date', 'end_date', 'use_flag', 'reg_date', 'reg_time',
...
class LectureUbtInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['quiz_code', 'lecture_code', 'use_flag', 'reg_date', 'reg_time', 'reg_agent', 'udt_date',
                    'udt_time', 'udt_agent']
...
class LessonInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['lecture_code', 'member_code', 'teacher_code', 'start_date', 'end_date', 'progress', 'use_flag',
...
class LessonLogAdmin(admin.ModelAdmin):
    ...
    list_display = ['lesson_code', 'lecture_code', 'chapter_code', 'member_code', 'member_id', 'member_ip',
...
class MemberGroupAdmin(admin.ModelAdmin):
    ...
    list_display = ['center_code', 'group_name', 'use_flag', 'reg_date', 'reg_time', 'reg_agent', 'udt_date',
                    'udt_time', 'udt_agent']
...
class MemberInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['member_id', 'member_level', 'member_pw', 'member_name', 'member_jumin', 'member_birth',
...
class MessageInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['teacher_code', 'member_code', 'message', 'message_read', 'use_flag', 'reg_date', 'reg_time',
                    'reg_agent', 'udt_date', 'udt_time', 'udt_agent']
...
class OmrAnswerInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['subject_code', 'lecture_code', 'chapter_code', 'member_code', 'question_code', 'omr_answer',
...
class OmrExampleInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['question_code', 'omr_example_correct', 'omr_example_idx', 'use_flag', 'reg_date', 'reg_time',
                    'reg_agent', 'udt_date', 'udt_time', 'udt_agent']
...
class OmrQuestionInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['subject_code', 'lecture_code', 'chapter_code', 'use_flag', 'reg_date', 'reg_time', 'reg_agent',
...
class QAnswerInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['subject_code', 'lecture_code', 'chapter_code', 'member_code', 'question_code', 'question_type',
...
class QAnswerLogAdmin(admin.ModelAdmin):
    ...
    list_display = ['lecture_code', 'member_code', 'question_code', 'question_answer', 'question_idx', 'question_score',
...
class QExampleInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['question_code', 'q_example', 'q_example_correct', 'q_example_idx', 'use_flag', 'reg_date',
...
class QuestionInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['subject_code', 'lecture_code', 'chapter_code', 'question_type', 'question', 'question_media_type',
...
class QuizAnswerInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['subject_code', 'lecture_code', 'chapter_code', 'member_code', 'quiz_code', 'quiz_type',
...
class QuizExampleInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['quiz_code', 'quiz_example', 'quiz_example_correct', 'quiz_example_idx', 'use_flag', 'reg_date',
...
class QuizInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['subject_code', 'lecture_code', 'chapter_code', 'quiz_type', 'quiz_question', 'quiz_media_type',
...
class ScheduleInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['member_code', 'title', 'content', 'start_date', 'start_time', 'end_date', 'end_time', 'use_flag',
                    'reg_date', 'reg_time', 'reg_agent', 'udt_date', 'udt_time', 'udt_agent']
...
class TodoInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['chapter_code', 'member_code', 'todo_comment', 'todo_status', 'use_flag', 'reg_date', 'reg_time',
...
class TodoTInfoAdmin(admin.ModelAdmin):
    ...
    list_display = ['todo_code', 'member_code', 'todo_t_flag', 'use_flag', 'reg_date', 'reg_time', 'reg_agent',
                    'udt_date', 'udt_time', 'udt_agent']
