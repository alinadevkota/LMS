...
urlpatterns += (
    ...
    path('lectureinfo/create/', views.LectureInfoCreateView.as_view(),
         name='lectureinfo_create'),
    path('lectureinfo/detail/<int:pk>/',
...
urlpatterns += (
    ...
    path('chapterinfo/detail/<int:pk>/',
...
urlpatterns += (
    ...
    path('chaptercontentsinfo/', views.ChapterContentsInfoListView.as_view(),
         name='chaptercontentsinfo_list'),
...
urlpatterns += (
    ...
    path('chaptermissoncheckcard/', views.ChapterMissonCheckCardListView.as_view(),
         name='chaptermissoncheckcard_list'),
...
urlpatterns += (
    ...
    path('chaptermissoncheckitem/', views.ChapterMissonCheckItemListView.as_view(),
         name='chaptermissoncheckitem_list'),
...
urlpatterns += (
    ...
    path('quizinfo/create/', views.QuizInfoCreateView.as_view(),
         name='quizinfo_create'),
    path('quizinfo/detail/<int:pk>/',
         views.QuizInfoDetailView.as_view(), name='quizinfo_detail'),
    path('quizinfo/update/<int:pk>/',
         views.QuizInfoUpdateView.as_view(), name='quizinfo_update'),
)
...
urlpatterns += (
    ...
    path('assignmentinfo/detail/<int:pk>/',
...
urlpatterns += (
    ...
    path('boardinfo/create/', views.BoardInfoCreateView.as_view(),
         name='boardinfo_create'),
    path('boardinfo/detail/<int:pk>/',
         views.BoardInfoDetailView.as_view(), name='boardinfo_detail'),
    path('boardinfo/update/<int:pk>/',
         views.BoardInfoUpdateView.as_view(), name='boardinfo_update'),
)

urlpatterns += (
    # urls for BoardContentInfo
    path('boardcontentinfo/', views.BoardContentInfoListView.as_view(),
         name='boardcontentinfo_list'),
    path('boardcontentinfo/create/', views.BoardContentInfoCreateView.as_view(),
         name='boardcontentinfo_create'),
...
urlpatterns += (
    ...
    path('chaptercontentmedia/', views.ChapterContentMediaListView.as_view(),
         name='chaptercontentmedia_list'),
...
urlpatterns += (
    ...
    path('chapterimginfo/', views.ChapterImgInfoListView.as_view(),
         name='chapterimginfo_list'),
    path('chapterimginfo/create/', views.ChapterImgInfoCreateView.as_view(),
         name='chapterimginfo_create'),
    path('chapterimginfo/detail/<int:pk>/',
         views.ChapterImgInfoDetailView.as_view(), name='chapterimginfo_detail'),
    path('chapterimginfo/update/<int:pk>/',
         views.ChapterImgInfoUpdateView.as_view(), name='chapterimginfo_update'),
)

urlpatterns += (
    # urls for ChapterMissonCheck
    path('chaptermissoncheck/', views.ChapterMissonCheckListView.as_view(),
         name='chaptermissoncheck_list'),
    path('chaptermissoncheck/create/', views.ChapterMissonCheckCreateView.as_view(),
         name='chaptermissoncheck_create'),
...
urlpatterns += (
    ...
    path('chapterwrite/', views.ChapterWriteListView.as_view(),
         name='chapterwrite_list'),
    path('chapterwrite/create/', views.ChapterWriteCreateView.as_view(),
         name='chapterwrite_create'),
    path('chapterwrite/detail/<int:pk>/',
         views.ChapterWriteDetailView.as_view(), name='chapterwrite_detail'),
...
urlpatterns += (
    ...
    path('learningnote/', views.LearningNoteListView.as_view(),
         name='learningnote_list'),
    path('learningnote/create/', views.LearningNoteCreateView.as_view(),
         name='learningnote_create'),
    path('learningnote/detail/<int:pk>/',
         views.LearningNoteDetailView.as_view(), name='learningnote_detail'),
    path('learningnote/update/<int:pk>/',
         views.LearningNoteUpdateView.as_view(), name='learningnote_update'),
)
...
urlpatterns += (
    ...
    path('lessoninfo/create/', views.LessonInfoCreateView.as_view(),
         name='lessoninfo_create'),
    path('lessoninfo/detail/<int:pk>/',
         views.LessonInfoDetailView.as_view(), name='lessoninfo_detail'),
    path('lessoninfo/update/<int:pk>/',
         views.LessonInfoUpdateView.as_view(), name='lessoninfo_update'),
)

urlpatterns += (
    # urls for LessonLog
    path('lessonlog/', views.LessonLogListView.as_view(), name='lessonlog_list'),
    path('lessonlog/create/', views.LessonLogCreateView.as_view(),
         name='lessonlog_create'),
    path('lessonlog/detail/<int:pk>/',
         views.LessonLogDetailView.as_view(), name='lessonlog_detail'),
    path('lessonlog/update/<int:pk>/',
         views.LessonLogUpdateView.as_view(), name='lessonlog_update'),
)

urlpatterns += (
    # urls for MemberGroup
    path('membergroup/', views.MemberGroupListView.as_view(),
         name='membergroup_list'),
    path('membergroup/create/', views.MemberGroupCreateView.as_view(),
         name='membergroup_create'),
    path('membergroup/detail/<int:pk>/',
         views.MemberGroupDetailView.as_view(), name='membergroup_detail'),
    path('membergroup/update/<int:pk>/',
         views.MemberGroupUpdateView.as_view(), name='membergroup_update'),
)
...
urlpatterns += (
    ...
    path('qexampleinfo/', views.QExampleInfoListView.as_view(),
         name='qexampleinfo_list'),
    path('qexampleinfo/create/', views.QExampleInfoCreateView.as_view(),
         name='qexampleinfo_create'),
    path('qexampleinfo/detail/<int:pk>/',
         views.QExampleInfoDetailView.as_view(), name='qexampleinfo_detail'),
    path('qexampleinfo/update/<int:pk>/',
         views.QExampleInfoUpdateView.as_view(), name='qexampleinfo_update'),
)

urlpatterns += (
    # urls for QuizAnswerInfo
    path('quizanswerinfo/', views.QuizAnswerInfoListView.as_view(),
         name='quizanswerinfo_list'),
    path('quizanswerinfo/create/', views.QuizAnswerInfoCreateView.as_view(),
         name='quizanswerinfo_create'),
    path('quizanswerinfo/detail/<int:pk>/',
         views.QuizAnswerInfoDetailView.as_view(), name='quizanswerinfo_detail'),
    path('quizanswerinfo/update/<int:pk>/',
         views.QuizAnswerInfoUpdateView.as_view(), name='quizanswerinfo_update'),
)

urlpatterns += (
    # urls for QuizExampleInfo
    path('quizexampleinfo/', views.QuizExampleInfoListView.as_view(),
         name='quizexampleinfo_list'),
    path('quizexampleinfo/create/', views.QuizExampleInfoCreateView.as_view(),
         name='quizexampleinfo_create'),
    path('quizexampleinfo/detail/<int:pk>/',
         views.QuizExampleInfoDetailView.as_view(), name='quizexampleinfo_detail'),
    path('quizexampleinfo/update/<int:pk>/',
         views.QuizExampleInfoUpdateView.as_view(), name='quizexampleinfo_update'),
)

urlpatterns += (
    # urls for ScheduleInfo
    path('scheduleinfo/', views.ScheduleInfoListView.as_view(),
         name='scheduleinfo_list'),
    path('scheduleinfo/create/', views.ScheduleInfoCreateView.as_view(),
         name='scheduleinfo_create'),
    path('scheduleinfo/detail/<int:pk>/',
         views.ScheduleInfoDetailView.as_view(), name='scheduleinfo_detail'),
    path('scheduleinfo/update/<int:pk>/',
         views.ScheduleInfoUpdateView.as_view(), name='scheduleinfo_update'),
)

urlpatterns += (
    # urls for TalkMember
    path('talkmember/', views.TalkMemberListView.as_view(), name='talkmember_list'),
    path('talkmember/create/', views.TalkMemberCreateView.as_view(),
         name='talkmember_create'),
    path('talkmember/detail/<int:pk>/',
         views.TalkMemberDetailView.as_view(), name='talkmember_detail'),
    path('talkmember/update/<int:pk>/',
         views.TalkMemberUpdateView.as_view(), name='talkmember_update'),
)

urlpatterns += (
    # urls for TalkRoom
    path('talkroom/', views.TalkRoomListView.as_view(), name='talkroom_list'),
    path('talkroom/create/', views.TalkRoomCreateView.as_view(),
         name='talkroom_create'),
    path('talkroom/detail/<int:pk>/',
         views.TalkRoomDetailView.as_view(), name='talkroom_detail'),
    path('talkroom/update/<int:pk>/',
         views.TalkRoomUpdateView.as_view(), name='talkroom_update'),
)

urlpatterns += (
    # urls for TalkMessage
    path('talkmessage/', views.TalkMessageListView.as_view(),
         name='talkmessage_list'),
    path('talkmessage/create/', views.TalkMessageCreateView.as_view(),
         name='talkmessage_create'),
    path('talkmessage/detail/<int:pk>/',
         views.TalkMessageDetailView.as_view(), name='talkmessage_detail'),
    path('talkmessage/update/<int:pk>/',
         views.TalkMessageUpdateView.as_view(), name='talkmessage_update'),
)

urlpatterns += (
    # urls for TalkMessageRead
    path('talkmessageread/', views.TalkMessageReadListView.as_view(),
         name='talkmessageread_list'),
    path('talkmessageread/create/', views.TalkMessageReadCreateView.as_view(),
         name='talkmessageread_create'),
    path('talkmessageread/detail/<int:pk>/',
         views.TalkMessageReadDetailView.as_view(), name='talkmessageread_detail'),
    path('talkmessageread/update/<int:pk>/',
         views.TalkMessageReadUpdateView.as_view(), name='talkmessageread_update'),
)

urlpatterns += (
    # urls for TodoInfo
    path('todoinfo/', views.TodoInfoListView.as_view(), name='todoinfo_list'),
    path('todoinfo/create/', views.TodoInfoCreateView.as_view(),
         name='todoinfo_create'),
    path('todoinfo/detail/<int:pk>/',
         views.TodoInfoDetailView.as_view(), name='todoinfo_detail'),
    path('todoinfo/update/<int:pk>/',
         views.TodoInfoUpdateView.as_view(), name='todoinfo_update'),
)

urlpatterns += (
    # urls for TodoTInfo
    path('todotinfo/', views.TodoTInfoListView.as_view(), name='todotinfo_list'),
    path('todotinfo/create/', views.TodoTInfoCreateView.as_view(),
         name='todotinfo_create'),
    path('todotinfo/detail/<int:pk>/',
         views.TodoTInfoDetailView.as_view(), name='todotinfo_detail'),
    path('todotinfo/update/<int:pk>/',
         views.TodoTInfoUpdateView.as_view(), name='todotinfo_update'),
)
urlpatterns += (
