...
# urlpatterns += (
#     # urls for Profile
#     path('WebApp/profile/', views.ProfileListView.as_view(), name='WebApp_profile_list'),
#     path('WebApp/profile/create/', views.ProfileCreateView.as_view(), name='WebApp_profile_create'),
#     path('WebApp/profile/detail/<int:pk>/', views.ProfileDetailView.as_view(), name='WebApp_profile_detail'),
#     path('WebApp/profile/update/<int:pk>/', views.ProfileUpdateView.as_view(), name='WebApp_profile_update'),
# )
...
urlpatterns += (
    ...
    path('WebApp/lectureinfo/detail/<int:pk>/', views.LectureInfoDetailView.as_view(), name='WebApp_lectureinfo_detail'),
    path('WebApp/lectureinfo/update/<int:pk>/', views.LectureInfoUpdateView.as_view(), name='WebApp_lectureinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/chapterinfo/detail/<int:pk>/', views.ChapterInfoDetailView.as_view(), name='WebApp_chapterinfo_detail'),
    path('WebApp/chapterinfo/update/<int:pk>/', views.ChapterInfoUpdateView.as_view(), name='WebApp_chapterinfo_update'),
)

urlpatterns += (
    # urls for ChapterContentsInfo
    path('WebApp/chaptercontentsinfo/', views.ChapterContentsInfoListView.as_view(), name='WebApp_chaptercontentsinfo_list'),
    path('WebApp/chaptercontentsinfo/create/', views.ChapterContentsInfoCreateView.as_view(), name='WebApp_chaptercontentsinfo_create'),
    path('WebApp/chaptercontentsinfo/detail/<int:pk>/', views.ChapterContentsInfoDetailView.as_view(), name='WebApp_chaptercontentsinfo_detail'),
    path('WebApp/chaptercontentsinfo/update/<int:pk>/', views.ChapterContentsInfoUpdateView.as_view(), name='WebApp_chaptercontentsinfo_update'),
)

urlpatterns += (
    # urls for ChapterMissonCheckCard
    path('WebApp/chaptermissoncheckcard/', views.ChapterMissonCheckCardListView.as_view(), name='WebApp_chaptermissoncheckcard_list'),
    path('WebApp/chaptermissoncheckcard/create/', views.ChapterMissonCheckCardCreateView.as_view(), name='WebApp_chaptermissoncheckcard_create'),
    path('WebApp/chaptermissoncheckcard/detail/<int:pk>/', views.ChapterMissonCheckCardDetailView.as_view(), name='WebApp_chaptermissoncheckcard_detail'),
    path('WebApp/chaptermissoncheckcard/update/<int:pk>/', views.ChapterMissonCheckCardUpdateView.as_view(), name='WebApp_chaptermissoncheckcard_update'),
)

urlpatterns += (
    # urls for ChapterMissonCheckItem
    path('WebApp/chaptermissoncheckitem/', views.ChapterMissonCheckItemListView.as_view(), name='WebApp_chaptermissoncheckitem_list'),
    path('WebApp/chaptermissoncheckitem/create/', views.ChapterMissonCheckItemCreateView.as_view(), name='WebApp_chaptermissoncheckitem_create'),
    path('WebApp/chaptermissoncheckitem/detail/<int:pk>/', views.ChapterMissonCheckItemDetailView.as_view(), name='WebApp_chaptermissoncheckitem_detail'),
    path('WebApp/chaptermissoncheckitem/update/<int:pk>/', views.ChapterMissonCheckItemUpdateView.as_view(), name='WebApp_chaptermissoncheckitem_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/omrquestioninfo/create/', views.OmrQuestionInfoCreateView.as_view(), name='WebApp_omrquestioninfo_create'),
    path('WebApp/omrquestioninfo/detail/<int:pk>/', views.OmrQuestionInfoDetailView.as_view(), name='WebApp_omrquestioninfo_detail'),
    path('WebApp/omrquestioninfo/update/<int:pk>/', views.OmrQuestionInfoUpdateView.as_view(), name='WebApp_omrquestioninfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/assignhomeworkinfo/', views.AssignHomeworkInfoListView.as_view(), name='WebApp_assignhomeworkinfo_list'),
    path('WebApp/assignhomeworkinfo/create/', views.AssignHomeworkInfoCreateView.as_view(), name='WebApp_assignhomeworkinfo_create'),
    path('WebApp/assignhomeworkinfo/detail/<int:pk>/', views.AssignHomeworkInfoDetailView.as_view(), name='WebApp_assignhomeworkinfo_detail'),
    path('WebApp/assignhomeworkinfo/update/<int:pk>/', views.AssignHomeworkInfoUpdateView.as_view(), name='WebApp_assignhomeworkinfo_update'),
)

urlpatterns += (
    # urls for AssignQuestionInfo
    path('WebApp/assignquestioninfo/', views.AssignQuestionInfoListView.as_view(), name='WebApp_assignquestioninfo_list'),
    path('WebApp/assignquestioninfo/create/', views.AssignQuestionInfoCreateView.as_view(), name='WebApp_assignquestioninfo_create'),
    path('WebApp/assignquestioninfo/detail/<int:pk>/', views.AssignQuestionInfoDetailView.as_view(), name='WebApp_assignquestioninfo_detail'),
    path('WebApp/assignquestioninfo/update/<int:pk>/', views.AssignQuestionInfoUpdateView.as_view(), name='WebApp_assignquestioninfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/boardcontentinfo/create/', views.BoardContentInfoCreateView.as_view(), name='WebApp_boardcontentinfo_create'),
    path('WebApp/boardcontentinfo/detail/<int:pk>/', views.BoardContentInfoDetailView.as_view(), name='WebApp_boardcontentinfo_detail'),
    path('WebApp/boardcontentinfo/update/<int:pk>/', views.BoardContentInfoUpdateView.as_view(), name='WebApp_boardcontentinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/inninggroup/detail/<int:pk>/', views.InningGroupDetailView.as_view(), name='WebApp_inninggroup_detail'),
    path('WebApp/inninggroup/update/<int:pk>/', views.InningGroupUpdateView.as_view(), name='WebApp_inninggroup_update'),
)

urlpatterns += (
    # urls for ChapterContentMedia
    path('WebApp/chaptercontentmedia/', views.ChapterContentMediaListView.as_view(), name='WebApp_chaptercontentmedia_list'),
    path('WebApp/chaptercontentmedia/create/', views.ChapterContentMediaCreateView.as_view(), name='WebApp_chaptercontentmedia_create'),
    path('WebApp/chaptercontentmedia/detail/<int:pk>/', views.ChapterContentMediaDetailView.as_view(), name='WebApp_chaptercontentmedia_detail'),
    path('WebApp/chaptercontentmedia/update/<int:pk>/', views.ChapterContentMediaUpdateView.as_view(), name='WebApp_chaptercontentmedia_update'),
)

urlpatterns += (
    # urls for ChapterImgInfo
    path('WebApp/chapterimginfo/', views.ChapterImgInfoListView.as_view(), name='WebApp_chapterimginfo_list'),
    path('WebApp/chapterimginfo/create/', views.ChapterImgInfoCreateView.as_view(), name='WebApp_chapterimginfo_create'),
    path('WebApp/chapterimginfo/detail/<int:pk>/', views.ChapterImgInfoDetailView.as_view(), name='WebApp_chapterimginfo_detail'),
    path('WebApp/chapterimginfo/update/<int:pk>/', views.ChapterImgInfoUpdateView.as_view(), name='WebApp_chapterimginfo_update'),
)

urlpatterns += (
    # urls for ChapterMissonCheck
    path('WebApp/chaptermissoncheck/', views.ChapterMissonCheckListView.as_view(), name='WebApp_chaptermissoncheck_list'),
    path('WebApp/chaptermissoncheck/create/', views.ChapterMissonCheckCreateView.as_view(), name='WebApp_chaptermissoncheck_create'),
    path('WebApp/chaptermissoncheck/detail/<int:pk>/', views.ChapterMissonCheckDetailView.as_view(), name='WebApp_chaptermissoncheck_detail'),
    path('WebApp/chaptermissoncheck/update/<int:pk>/', views.ChapterMissonCheckUpdateView.as_view(), name='WebApp_chaptermissoncheck_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/chapterwrite/detail/<int:pk>/', views.ChapterWriteDetailView.as_view(), name='WebApp_chapterwrite_detail'),
    path('WebApp/chapterwrite/update/<int:pk>/', views.ChapterWriteUpdateView.as_view(), name='WebApp_chapterwrite_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/groupmapping/detail/<int:pk>/', views.GroupMappingDetailView.as_view(), name='WebApp_groupmapping_detail'),
    path('WebApp/groupmapping/update/<int:pk>/', views.GroupMappingUpdateView.as_view(), name='WebApp_groupmapping_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/homeworkinfo/detail/<int:pk>/', views.HomeworkInfoDetailView.as_view(), name='WebApp_homeworkinfo_detail'),
    path('WebApp/homeworkinfo/update/<int:pk>/', views.HomeworkInfoUpdateView.as_view(), name='WebApp_homeworkinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/learningnote/detail/<int:pk>/', views.LearningNoteDetailView.as_view(), name='WebApp_learningnote_detail'),
    path('WebApp/learningnote/update/<int:pk>/', views.LearningNoteUpdateView.as_view(), name='WebApp_learningnote_update'),
)

urlpatterns += (
    # urls for LectureUbtInfo
    path('WebApp/lectureubtinfo/', views.LectureUbtInfoListView.as_view(), name='WebApp_lectureubtinfo_list'),
    path('WebApp/lectureubtinfo/create/', views.LectureUbtInfoCreateView.as_view(), name='WebApp_lectureubtinfo_create'),
    path('WebApp/lectureubtinfo/detail/<int:pk>/', views.LectureUbtInfoDetailView.as_view(), name='WebApp_lectureubtinfo_detail'),
    path('WebApp/lectureubtinfo/update/<int:pk>/', views.LectureUbtInfoUpdateView.as_view(), name='WebApp_lectureubtinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/membergroup/detail/<int:pk>/', views.MemberGroupDetailView.as_view(), name='WebApp_membergroup_detail'),
    path('WebApp/membergroup/update/<int:pk>/', views.MemberGroupUpdateView.as_view(), name='WebApp_membergroup_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/messageinfo/detail/<int:pk>/', views.MessageInfoDetailView.as_view(), name='WebApp_messageinfo_detail'),
    path('WebApp/messageinfo/update/<int:pk>/', views.MessageInfoUpdateView.as_view(), name='WebApp_messageinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/omranswerinfo/detail/<int:pk>/', views.OmrAnswerInfoDetailView.as_view(), name='WebApp_omranswerinfo_detail'),
    path('WebApp/omranswerinfo/update/<int:pk>/', views.OmrAnswerInfoUpdateView.as_view(), name='WebApp_omranswerinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/omrassigninfo/detail/<int:pk>/', views.OmrAssignInfoDetailView.as_view(), name='WebApp_omrassigninfo_detail'),
    path('WebApp/omrassigninfo/update/<int:pk>/', views.OmrAssignInfoUpdateView.as_view(), name='WebApp_omrassigninfo_update'),
)

urlpatterns += (
    # urls for OmrExampleInfo
    path('WebApp/omrexampleinfo/', views.OmrExampleInfoListView.as_view(), name='WebApp_omrexampleinfo_list'),
    path('WebApp/omrexampleinfo/create/', views.OmrExampleInfoCreateView.as_view(), name='WebApp_omrexampleinfo_create'),
    path('WebApp/omrexampleinfo/detail/<int:pk>/', views.OmrExampleInfoDetailView.as_view(), name='WebApp_omrexampleinfo_detail'),
    path('WebApp/omrexampleinfo/update/<int:pk>/', views.OmrExampleInfoUpdateView.as_view(), name='WebApp_omrexampleinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/qanswerinfo/detail/<int:pk>/', views.QAnswerInfoDetailView.as_view(), name='WebApp_qanswerinfo_detail'),
    path('WebApp/qanswerinfo/update/<int:pk>/', views.QAnswerInfoUpdateView.as_view(), name='WebApp_qanswerinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/qexampleinfo/detail/<int:pk>/', views.QExampleInfoDetailView.as_view(), name='WebApp_qexampleinfo_detail'),
    path('WebApp/qexampleinfo/update/<int:pk>/', views.QExampleInfoUpdateView.as_view(), name='WebApp_qexampleinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/questioninfo/detail/<int:pk>/', views.QuestionInfoDetailView.as_view(), name='WebApp_questioninfo_detail'),
    path('WebApp/questioninfo/update/<int:pk>/', views.QuestionInfoUpdateView.as_view(), name='WebApp_questioninfo_update'),
)

urlpatterns += (
    # urls for QuizAnswerInfo
    path('WebApp/quizanswerinfo/', views.QuizAnswerInfoListView.as_view(), name='WebApp_quizanswerinfo_list'),
    path('WebApp/quizanswerinfo/create/', views.QuizAnswerInfoCreateView.as_view(), name='WebApp_quizanswerinfo_create'),
    path('WebApp/quizanswerinfo/detail/<int:pk>/', views.QuizAnswerInfoDetailView.as_view(), name='WebApp_quizanswerinfo_detail'),
    path('WebApp/quizanswerinfo/update/<int:pk>/', views.QuizAnswerInfoUpdateView.as_view(), name='WebApp_quizanswerinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/quizexampleinfo/create/', views.QuizExampleInfoCreateView.as_view(), name='WebApp_quizexampleinfo_create'),
    path('WebApp/quizexampleinfo/detail/<int:pk>/', views.QuizExampleInfoDetailView.as_view(), name='WebApp_quizexampleinfo_detail'),
    path('WebApp/quizexampleinfo/update/<int:pk>/', views.QuizExampleInfoUpdateView.as_view(), name='WebApp_quizexampleinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/scheduleinfo/detail/<int:pk>/', views.ScheduleInfoDetailView.as_view(), name='WebApp_scheduleinfo_detail'),
    path('WebApp/scheduleinfo/update/<int:pk>/', views.ScheduleInfoUpdateView.as_view(), name='WebApp_scheduleinfo_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/talkmessage/detail/<int:pk>/', views.TalkMessageDetailView.as_view(), name='WebApp_talkmessage_detail'),
    path('WebApp/talkmessage/update/<int:pk>/', views.TalkMessageUpdateView.as_view(), name='WebApp_talkmessage_update'),
)
...
urlpatterns += (
    ...
    path('WebApp/talkmessageread/create/', views.TalkMessageReadCreateView.as_view(), name='WebApp_talkmessageread_create'),
    path('WebApp/talkmessageread/detail/<int:pk>/', views.TalkMessageReadDetailView.as_view(), name='WebApp_talkmessageread_detail'),
    path('WebApp/talkmessageread/update/<int:pk>/', views.TalkMessageReadUpdateView.as_view(), name='WebApp_talkmessageread_update'),
)
