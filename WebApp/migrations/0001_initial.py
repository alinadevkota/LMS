# Generated by Django 2.2.2 on 2019-07-12 16:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='inninginfo',
            name='Teacher_Code',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='inninginfos', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='InningGroup',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Updated_DateTime', models.DateTimeField(auto_now=True)),
                ('Register_Agent', models.CharField(blank=True, max_length=500, null=True)),
                ('Center_Code', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='WebApp.CenterInfo')),
                ('Group_Code', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='WebApp.InningGroup')),
                ('Member_Code', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-pk',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Teacher_Code', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='assignhomeworkinfos', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-pk',),
            },
